...
func (c *ApiClient) LeagueStandingsBySeasonId(seasonId int, include []string) (*LeagueStandings, *Meta, error) {
...
func (c *ApiClient) LiveLeagueStandingsBySeasonId(seasonId int, include []string) (*LeagueStandings, *Meta, error) {
