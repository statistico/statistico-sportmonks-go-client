...
func (c *ApiClient) FixturesById(ids []string, includes []string) ([]Fixture, *Meta, error) {
...
func (c *ApiClient) FixturesByDate(date string, includes []string) ([]Fixture, *Meta, error) {
...
func (c *ApiClient) FixturesBetween(dateFrom, dateTo string, includes []string) ([]Fixture, *Meta, error) {
...
func (c *ApiClient) FixturesBetweenForTeam(dateFrom, dateTo string, teamId int, includes []string) ([]Fixture, *Meta, error) {
...
// data.
func (c *ApiClient) FixturesLastUpdated(includes []string) ([]Fixture, *Meta, error) {
	response := new(FixturesResponse)
